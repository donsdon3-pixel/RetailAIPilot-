...
describe('AI Agents & MCP Calling Test Suite (5 Cases)', () => {
  ...
  it('AI-03: Data Consistency Check (in-memory) matches application state numbers', async () => {
  ...
  it('AI-04: Mandatory AI Disclaimer is always attached to assistant output', async () => {
    ...
    expect(res.disclaimer).toContain('AI-generated operational recommendation');
  });
