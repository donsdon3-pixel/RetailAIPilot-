...
[![QA Test Suite](https://img.shields.io/badge/QA%20Tests-50%20Passing%20(100%25)-emerald)](docs/QA_TESTING_MATRIX.md)
...
### 1. Installation
```bash
git clone https://github.com/donsdon3-pixel/RetailAIPilot-.git
cd RetailAIPilot
npm install
```
